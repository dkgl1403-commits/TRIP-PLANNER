"""
Script to generate CODEBASE_CONTEXT.md
Run this to regenerate the context file.
"""

content = """# TRIP Planner — Codebase Context File
...
import os
size = os.path.getsize('CODEBASE_CONTEXT.md')
print(f"CODEBASE_CONTEXT.md written successfully: {size:,} bytes ({size//1024} KB)")
